      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-2xl border-none shadow-2xl rounded-3xl bg-card">
          ...
          <CardContent className="p-8 md:p-12 text-center space-y-10">
            <div className="w-20 h-20 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 rounded-full flex items-center justify-center mx-auto ring-8 ring-emerald-50/50 dark:ring-emerald-950/20">
              <CheckCircle2 size={40} className="animate-in zoom-in duration-500" />
            </div>
            
            <div className="space-y-2">
              <h1 className="text-3xl font-headline font-bold text-foreground">Result Generated</h1>
              <p className="text-muted-foreground font-medium">Session ID: <span className="text-foreground font-bold font-mono">{testId}</span></p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-5 bg-muted/30 rounded-2xl border border-border">
                ...
                <p className="text-[9px] font-black uppercase text-muted-foreground tracking-wider">Score</p>
              </div>
              <div className="p-5 bg-muted/30 rounded-2xl border border-border">
                <p className="text-2xl font-black text-primary">{attempted}/{questions.length}</p>
                <p className="text-[9px] font-black uppercase text-muted-foreground tracking-wider">Attempted</p>
              </div>
              <div className="p-5 bg-muted/30 rounded-2xl border border-border">
                <p className="text-2xl font-black text-primary">{Math.round((score / questions.length) * 100)}%</p>
                <p className="text-[9px] font-black uppercase text-muted-foreground tracking-wider">Accuracy</p>
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col font-body">
      ...
      <div className="flex-grow flex flex-col md:flex-row overflow-hidden h-[calc(100vh-3.5rem)]">
        <div className="flex-grow flex flex-col min-w-0 bg-card md:m-3 md:rounded-2xl border shadow-sm">
          ...
          <ScrollArea className="flex-grow">
            <div className="max-w-5xl mx-auto p-6 md:p-12 space-y-8">
              <div className="text-lg md:text-xl font-medium leading-relaxed text-foreground min-h-[60px]">
                {currentQuestion.mdx ? (
          ...
          <footer className="p-3 border-t bg-card flex items-center justify-between px-6">
            <div className="flex items-center gap-2">
              <Button 
                variant="outline" 
                className="rounded-lg font-bold h-9 px-4 border-border text-muted-foreground text-[10px] gap-2" 
              ...
              <Button 
                variant="ghost" 
                className="rounded-lg font-bold h-9 text-muted-foreground hover:text-rose-500 text-[10px]" 
            ...
            <div className="flex items-center gap-3">
              <Button 
                variant="outline" 
                className="rounded-lg font-bold h-9 px-4 border-border disabled:opacity-30 text-[10px]" 
        ...
        <aside className="w-full md:w-72 flex flex-col h-full shrink-0 md:py-3 md:pr-3">
          <div className="bg-card h-full border md:rounded-2xl shadow-sm flex flex-col overflow-hidden">
            ...
            <div className="p-5 flex-grow flex flex-col min-h-0">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected ? "border-slate-400 dark:border-slate-500" : "border-border",
              ...
              <div className="mt-6 pt-6 border-t border-border space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="flex items-center gap-2">
                    <div className="h-3 w-3 rounded bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/50" />
                    <span className="text-[9px] font-bold text-muted-foreground">Answered</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-3 w-3 rounded bg-muted/50 border border-border" />
                    <span className="text-[9px] font-bold text-muted-foreground">Skipped</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-3 w-3 rounded bg-purple-50 dark:bg-purple-950/30 border border-purple-100 dark:border-purple-900/50" />
                    <span className="text-[9px] font-bold text-muted-foreground">Review</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-3 w-3 rounded bg-muted/50 border border-border" />
                    <span className="text-[9px] font-bold text-muted-foreground">Not Visited</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-t">
              <Button 
                variant="outline" 
                className="w-full h-10 rounded-lg border-border text-rose-600 dark:text-rose-400 text-[10px] font-bold gap-2 hover:bg-rose-50 dark:hover:bg-rose-950/20"
                onClick={() => router.back()}
              >
