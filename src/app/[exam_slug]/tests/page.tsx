...
export default function TestsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-4">
        <h2 className="text-xl md:text-2xl font-headline font-bold">Sectional Tests</h2>
        <p className="text-muted-foreground text-xs md:text-sm">Focus on individual topics and subjects.</p>
      </div>
        ...
        <aside className="hidden lg:block w-72 shrink-0">
          <Card className="border-none shadow-md overflow-hidden sticky top-48">
            <div className="bg-primary/5 p-4 border-b">
              <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Filter by Subject</span>
            </div>
        ...
        <div className="flex-grow">
          <div className="mb-4 flex items-center justify-between">
            <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider">
              Showing {filteredTests.length} tests in {selectedSubject}
            </span>
          </div>
