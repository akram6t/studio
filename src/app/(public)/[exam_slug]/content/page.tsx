                  ...
                  >
                    <Card className="aspect-[3/4.2] relative overflow-hidden border-none shadow-md bg-white dark:bg-card group-hover:-translate-y-1.5 transition-all duration-500 flex flex-col">
                      ...
                      <div className="absolute top-0 left-3 z-30">
                        {item.isFree ? (
                          <div className="bg-emerald-500 text-white text-[8px] font-black px-2.5 py-1 rounded-b-md shadow-lg flex items-center gap-1 uppercase tracking-widest">
                            Free
                          </div>
                        ) : (
                          <div className={cn(
                            "text-white text-[8px] font-black px-2.5 py-1 rounded-b-md shadow-lg flex items-center gap-1 uppercase tracking-widest",
